...
public class SinaBottomAct extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sina_bottom);
    ...
    class CustomDialog extends Dialog
    {
        ...
        private void init() {
            View mView  = LayoutInflater.from(mContext).inflate(R.layout.sina_bottom_dialog_layout,null);
