package com.joephone.codebox.act.other.SpannableStringBuilder.act;
...
import com.joephone.codebox.MainActivity;
import com.joephone.codebox.R;
import com.joephone.codebox.act.other.SpannableStringBuilder.adapter.ListViewAdapter;

import java.util.ArrayList;
import java.util.List;

public class SpannableAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.spannable_main);
		...
		listView.setAdapter(new ListViewAdapter(SpannableAct.this, spannablesbList));
	}
	...
	private void setSpannableSBText() {
		...
		ssb.setSpan(new URLSpan("cacaca") {
			...
			public void onClick(View widget) {
				Toast.makeText(SpannableAct.this, "点击了设置的链接", 0).show();
			}
		...
		ssb.setSpan(new ClickableSpan() {
			@Override
			public void onClick(View widget) {
				Toast.makeText(SpannableAct.this, "图片点击事件的处理 ", 0).show();
			}
		...
		ssb.setSpan(new ClickableSpan() {
			@Override
			public void onClick(View widget) {
				Toast.makeText(SpannableAct.this, "更复杂的点击效果", 0).show();
			}
		}, 3, 4, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
