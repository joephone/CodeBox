...
import com.joephone.codebox.act.list.view.DropBackListView;


public class DropBackAct extends Activity {

	private Context sContext;
	private List<String> sNewsList;
	private NewsAdapter sNewsAdapter;
	private DropBackListView sListView;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.list_drop_back);
		sContext = this;
		sNewsList = new ArrayList<String>();
		geneItems();
		sListView = (DropBackListView) findViewById(R.id.xListView);
//		sListView.setImageId(R.drawable.top_img);//可以再资源文件中通过 imglistview:headimage="@drawable/top_img"   设置图片，也可通过本方法
	...
	private class NewsAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				h = new Holder();
				convertView = mInflater.inflate(R.layout.list_drop_back_item, null);
