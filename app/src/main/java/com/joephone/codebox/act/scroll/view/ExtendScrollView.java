...
/**
 * Created by joephone on 2016/8/8.
 */
public class ExtendScrollView extends ScrollView {

    private ExtendScrollListener onScrollListener;
    /**
     ...
     */
    public void setOnScrollListener(ExtendScrollListener onScrollListener){
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            int scrollY = ExtendScrollView.this.getScrollY();
