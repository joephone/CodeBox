package com.joephone.codebox.act.classic.san;
...
import com.joephone.codebox.act.classic.model.Cityinfo;
import com.joephone.codebox.act.classic.util.CitycodeUtil;
import com.joephone.codebox.act.classic.util.FileUtil;
...
//			System.out.println(province_list_code.size());
		...
		public HashMap<String, List<Cityinfo>> getJSONParserResultArray(
			...
			Log.i("CityPicker","JSONString----"+JSONString);
			...
			while (iterator.hasNext()) {
				...
				Log.i("CityPicker","entry.getKey()----"+entry.getKey());
				hashMap.put(entry.getKey(), list);
			}

			for (String s : hashMap.keySet()) {
				Log.i("CityPicker","key:" + s+" values:" + hashMap.get(s));
			}
	...
	protected void onFinishInflate() {
		...
		provincePicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
			...
			public void endSelect(int id, String text) {
				// TODO Auto-generated method stub
				System.out.println("end id-->" + id + "province text----->" + provincePicker.getSelectedText()+""+cityPicker.getSelectedText());
			...
			public void selecting(int id, String text) {
				...
				System.out.println("selecting id-->" + id + "province text----->" + provincePicker.getSelectedText());
			}
		});
		cityPicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
			...
			public void endSelect(int id, String text) {
				// TODO Auto-generated method stub
				System.out.println("end id-->" + id + "city text----->" + cityPicker.getSelectedText());
				if (text.equals("") || text == null)
					return;
				if (temCityIndex != id) {
					...
					if (selectProvince == null || selectProvince.equals(""))
						return;
					String selectCountry = counyPicker.getSelectedText();
			...
			public void selecting(int id, String text) {
				// TODO Auto-generated method stub
				System.out.println("selecting id-->" + id + "city text----->" + cityPicker.getSelectedText());
			}
		});
		counyPicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
			...
			public void endSelect(int id, String text) {
				// TODO Auto-generated method stub
				System.out.println("endSelect id-->" + id + "couny text----->" + counyPicker.getSelectedText());
				if (text.equals("") || text == null)
					return;
			...
			public void selecting(int id, String text) {
				...
				System.out.println("selecting id-->" + id + "couny text----->" + counyPicker.getSelectedText());
			}
		});
	}
	...
	private void initFullName(){
		setFullName(provincePicker.getSelectedText()+"  "+cityPicker.getSelectedText() + "  "+ counyPicker.getSelectedText());
	}
