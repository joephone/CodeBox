...
public class OtherVoteBeautyAdapter extends BaseAdapter{
	...
	public OtherVoteBeautyAdapter(Context context, List<OtherVote> listItems){
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.other_vote_beauty_item, null);
			viewHolder.image = (ImageView) convertView.findViewById(R.id.iv_gridview);
			viewHolder.rl_progress = (RelativeLayout) convertView.findViewById(R.id.rl_progress);
			viewHolder.currentNum = (TextView) convertView.findViewById(R.id.currentNum);
			viewHolder.currentPrecent = (TextView) convertView.findViewById(R.id.currentPercent);
			viewHolder.progressBar = (ProgressBar) convertView.findViewById(R.id.progressBar1);
			viewHolder.tv_optionName = (TextView) convertView.findViewById(R.id.tv_optionName);
//			viewHolder.imagePoll = (ImageView) convertView.findViewById(R.id.image_poll);
		...
		final ImageView imagePoll = (ImageView) convertView.findViewById(R.id.polled);
		viewHolder.imagePoll = imagePoll;
		
		final RadioButton radio = (RadioButton) convertView.findViewById(R.id.rb_gridview);
		...
		viewHolder.optionName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				OtherVoteBeautyAdapter.this.notifyDataSetChanged();
			}
		});
		boolean res = false;
...
//			//单选按钮是否选中
			if (radio.isChecked()) {
				//心形图片
				viewHolder.imagePoll.setBackground(convertView.getResources().getDrawable(R.drawable.other_vote_gooded));
			}
